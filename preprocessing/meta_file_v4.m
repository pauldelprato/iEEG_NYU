%%%%%%%%%%%%
% please rename when adding a case to the switch function
% i.e. meta_file_v4.m when 4 total cases are in the script
%%%%%%%%%%%%

function params = meta_file_v4(dataset_idx)
