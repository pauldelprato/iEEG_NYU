function varargout = confplot_3andC_PD(x,y,err,c)
%CONFPLOT_3ANDC Linear plot with continuous confidence/error boundaries.
%
%   CONFPLOT_3ANDC(X,Y,ERR,C) plots the graph of vector X vs. vector Y with
%   'continuous' confidence/error boundaries specified by the vector
%   ERR in the color specified by C.
%
%   H = CONFPLOT_3ANDC(...) returns a vector of line handles.
%
%   For example,
%      x = 1:0.1:10;
%      y = sin(x);
